import {
  ...
  const CreateActivityWidget = ({ picturePath }) => {
    const dispatch = useDispatch();
    const [isImage, setIsImage] = useState(false);
    const [image, setImage] = useState(null);
    const [isGpxFile, setIsGpxFile] = useState(false)
    ...
    return (
      <WidgetWrapper>
        ...
        <FlexBetween>
          ...
          {isNonMobileScreens ? (
            <>
              <FlexBetween gap="0.25rem" onClick={() => setIsGpxFile(!isGpxFile)}>
