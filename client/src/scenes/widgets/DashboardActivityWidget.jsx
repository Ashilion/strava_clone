    ...
    return (
      <WidgetWrapper m="2rem 0">
        ...
        <FlexBetween gap="1.5rem" mt="1rem" style={{flexDirection:'column', width:"100%"}}>
          ...
          <FlexBetween width="100%"  style ={{justifyContent:"space-between"}}>
            <Typography color={medium} >{denivelePositif} mètres</Typography>
            <Typography color={medium} >{heartrateMean} bpm</Typography>
            <Typography color={medium} >{scoreTrimp} score</Typography>
          </FlexBetween>
